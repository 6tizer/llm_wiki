...
| [SPEC-5/pr3-staging-validator-plan.md](./SPEC-5/pr3-staging-validator-plan.md) | SPEC-5 PR3 执行计划：Staging artifact parser、validator、runtime staging store。 | implemented / PR-ready |
