...
| [SPEC-5/pr4-commit-integration-plan.md](./SPEC-5/pr4-commit-integration-plan.md) | SPEC-5 PR4 执行计划：Commit operation integration、runtime staging body reader、repair route、derived stale marker。 | active |
