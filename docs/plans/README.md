...
| [SPEC-5/remaining-prs-implementation-plan.md](./SPEC-5/remaining-prs-implementation-plan.md) | SPEC-5 六个 PR 连续执行总方案：PR1-PR6 顺序、gate、合并标准、PR6 当前修正点。 | active |
...
| [SPEC-5/pr6-progress-ui-plan.md](./SPEC-5/pr6-progress-ui-plan.md) | SPEC-5 PR6 执行计划：Progress / ETA / pause / resume / cancel UI、Runtime Diagnostics closeout。 | active |
