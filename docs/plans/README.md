...
| [SPEC-5/pr5-long-document-map-reduce-plan.md](./SPEC-5/pr5-long-document-map-reduce-plan.md) | SPEC-5 PR5 执行计划：Long-document map-reduce analysis、partial draft、chunk repair route。 | active |
