...
| [SPEC-5/pr2-prepare-worker-pool-plan.md](./SPEC-5/pr2-prepare-worker-pool-plan.md) | SPEC-5 PR2 执行计划：Prepare worker pool、scoped job claim、model-call profile routing。 | planned |
